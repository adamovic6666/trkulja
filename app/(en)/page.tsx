    ...
    <main>
      ...
      >
        <div className="mx-auto w-full max-w-[1200px]">
          ...
          <div className="mx-auto mt-14 grid w-[min(760px,100%)] grid-cols-[320px_1fr] gap-3 rounded-4xl bg-black max-md:mt-7 max-md:w-[min(240px,100%)] max-md:grid-cols-1 max-md:3xl">
            <img
      ...
      <section
        id="work"
        className="w-full rounded-t-[88px] bg-black px-8 py-20 max-md:rounded-t-[34px] max-md:px-5 max-md:py-16"
      >
        <div className="mx-auto w-full max-w-[1200px]">
